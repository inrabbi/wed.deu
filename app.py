...
app.config['MAIL_USERNAME'] = 'Adamsmithideology@gmail.com'  # Your Gmail email address
app.config['MAIL_PASSWORD'] = 'Ugfqnkbieewwfmqs'  # Your Gmail password or App Password
