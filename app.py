...
app.config['MAIL_USERNAME'] = 'yaskwhyifnoty09@gmail.com'  # Your Gmail email address
app.config['MAIL_PASSWORD'] = 'qzisvxklyrfqnixu'  # Your Gmail password or App Password
